...
export const PORTFOLIO_DATA: PortfolioData = {
  personalInfo: {
    name: "PRADEEP B",
    title: "Founder of Softech | Learning & Development Lead | Campus to Corporate Training Specialist",
    tagline: "Founder of Softech | Architecting Tech Training Ecosystems & Scalable Web Solutions",
    summary: "Founder of Softech (https://reachsoftech.onrender.com/home) — an enterprise web platform where users and students can find job opportunities and technical courses. L&D Lead & Master Technical Trainer with 4+ years of end-to-end training program ownership across premier engineering institutions (VIT University, SIT Madurai, KSR Institutions). Mentored 7,500+ engineering students, architected campus-to-corporate learning programs driving placement rates from 70% to 90%, led a 25-member trainer team, and built open-source developer tools.",
    location: "Tamil Nadu, India",
    yearsExperience: "4+ Years",
    clearanceLevel: "Level 5 Executive Access",
    developerRating: "Founder of Softech & L&D Architect",
  ...
  socialLinks: {
    ...
    portfolioUrl: "https://reachsoftech.onrender.com/home",
  },
  ...
  stats: {
    ...
    trainerTeamSize: "25",
    flagshipProjects: "10 Repositories",
    totalGames: "7 Games",
  ...
  careerPhases: [
    {
      id: "phase-softech-founder",
      title: "FOUNDER & LEAD ARCHITECT - SOFTECH",
      roleTitle: "Founder & Lead Platform Architect",
      dates: "2024 – PRESENT",
      description: "Founded Softech (reachsoftech.onrender.com/home), an enterprise career portal where users find job placements and technical courses.",
      strataColor: "#178F7F",
      layerDepthMin: 0,
      layerDepthMax: 20,
    },
  ...
  projects: [
    {
      id: "softech-platform",
      title: "Softech - Jobs & Technical Courses Portal",
      subtitle: "Enterprise Career Placement & Technical Learning Platform",
      category: "Full-Stack & 3D",
      role: "Founder, Lead Architect & Creator",
      timeframe: "2024 - Present",
      releaseYear: 2026,
      description: "Official web application and career platform for Softech, founded by Pradeep B. Users and students can find job opportunities, placement drives, online/offline courses, placement training, and 1-on-1 mentorship.",
      highlights: [
        "Founder & Lead Developer of the Softech web application platform.",
        "Facilitates job matching, course catalog discovery, and campus recruitment drives.",
        "Built with Python Flask, SQLAlchemy, SQLite/PostgreSQL, Bootstrap 5.3, and admin suite.",
      ],
      metrics: [
        { label: "Founder", value: "Pradeep B" },
        { label: "Live Website", value: "reachsoftech.onrender.com" },
        { label: "Core Services", value: "Jobs & Courses" },
      ],
      techStack: ["Python", "Flask", "SQLite", "PostgreSQL", "Bootstrap 5", "Render", "JavaScript"],
      githubUrl: "https://github.com/Pradeep-B28/Softech",
      liveUrl: "https://reachsoftech.onrender.com/home",
      color: "#178F7F",
      reelColor: "#178F7F",
      complexity: 5,
      valuation: 450000,
      boxNumber: "VAULT-000",
      codeName: "ORBIT-00",
      cartridgeCode: "CART-00",
      takeType: "GOOD TAKE",
      isAnchor: true,
      depth: 0,
      codeSnippet: `// Softech Career & Course Platform\nconst platform = {\n  founder: "Pradeep B",\n  url: "https://reachsoftech.onrender.com/home",\n  offerings: ["Jobs", "Courses", "Placement Training"]\n};`,
    },
    {
      id: "schema-sentinel",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/Pradeep-B28/GIT_3D_Portfolio",
      liveUrl: "https://pradeep-b28.github.io/GIT_3D_Portfolio/",
      color: "#10B981",
      reelColor: "#10B981",
      complexity: 5,
      valuation: 320000,
